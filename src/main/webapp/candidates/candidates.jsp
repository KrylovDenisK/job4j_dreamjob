...
<div class="container pt-3">
    <div class="row">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/authorization/login.jsp"><c:out value="${user.name}"/> | Выйти</a>
            </li>
        </ul>
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <c:forEach items="${candidates}" var="cand">
                        <tr>
                            <td>
                                <a href='<c:url value="/candidates/edit.jsp?id=${cand.id}&idCity=${cand.idCity}"/>'>
